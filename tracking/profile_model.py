...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='artrack', choices=['ostrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='artrack_384_got', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if "artrack" in args.script:
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_artrack
